...
@section('title', 'Customer Support Centre')
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div>
                    <h4 class="mb-sm-0">Customer Support Centre</h4>
                    <p class="text-muted mb-0">Manage customer issues, SLAs, assignment, internal notes and escalation</p>
                </div>
                <div class="page-title-right d-flex gap-2 align-items-center">
                    ...
                    <a href="#" class="btn btn-primary btn-sm"><i class="ri-add-line"></i> New Ticket</a>
                </div>
            </div>
        </div>
    </div>
