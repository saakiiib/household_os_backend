...
@section('title', 'Household Health Scores')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="mb-sm-0 font-size-18">Household Health Scores</h4>
                        <p class="text-muted mb-0">Wellbeing, engagement and risk scoring per household.</p>
                    </div>
