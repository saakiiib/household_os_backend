        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <div>
                    ...
                    <p class="text-muted mb-0">Create, optimise, schedule and moderate content</p>
                </div>
                <div class="page-title-right d-flex gap-2 align-items-center">
                    ...
                    <a href="#" class="btn btn-primary btn-sm"><i class="ri-add-line"></i> New Article</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Articles</h4>
