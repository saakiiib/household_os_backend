...
@section('title', 'Fraud & Abuse Detection')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="mb-sm-0 font-size-18">Fraud & Abuse Detection</h4>
                        <p class="text-muted mb-0">Suspicious activity, abuse signals and risk monitoring.</p>
                    </div>
