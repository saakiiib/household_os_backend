    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                @php($active = $active ?? request()->route('page') ?? '')
                @php($cur = $active)
                ...
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'users']) }}" class="nav-link {{ $cur === 'users' ? 'active' : '' }}"><i class="ri-user-line"></i><span>Users</span></a></li>
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'households']) }}" class="nav-link {{ $cur === 'households' ? 'active' : '' }}"><i class="ri-home-line"></i><span>Households</span></a></li>
                ...
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'admin-roles']) }}" class="nav-link {{ $cur === 'admin-roles' ? 'active' : '' }}"><i class="ri-shield-keyhole-line"></i><span>Admin Roles</span></a></li>

                <li class="menu-title">Operations</li>
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'tasks']) }}" class="nav-link {{ $cur === 'tasks' ? 'active' : '' }}"><i class="ri-task-line"></i><span>Tasks</span></a></li>
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'renewals']) }}" class="nav-link {{ $cur === 'renewals' ? 'active' : '' }}"><i class="ri-refresh-line"></i><span>Renewals</span></a></li>
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'documents']) }}" class="nav-link {{ $cur === 'documents' ? 'active' : '' }}"><i class="ri-file-text-line"></i><span>Documents</span></a></li>
                ...
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'subscriptions']) }}" class="nav-link {{ $cur === 'subscriptions' ? 'active' : '' }}"><i class="ri-star-line"></i><span>Subscriptions</span></a></li>
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'payments']) }}" class="nav-link {{ $cur === 'payments' ? 'active' : '' }}"><i class="ri-money-dollar-circle-line"></i><span>Payments</span></a></li>
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'refunds']) }}" class="nav-link {{ $cur === 'refunds' ? 'active' : '' }}"><i class="ri-refund-2-line"></i><span>Refunds</span></a></li>
                <li class="nav-item"><a href="{{ route('admin.page', ['page' => 'coupons']) }}" class="nav-link {{ $cur === 'coupons' ? 'active' : '' }}"><i class="ri-ticket-line"></i><span>Coupons</span></a></li>
                ...
                <li class="menu-title">Support &amp; Comms</li>
